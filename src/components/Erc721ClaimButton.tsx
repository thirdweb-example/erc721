          ...
          <div>
            <div className="h-12 flex border border-gray-800 rounded-lg px-2">
              <button
                ...
                className="w-1/3 h-full text-center text-white rounded-l-md text-2xl flex justify-center items-center px-2"
              >
                -
              </button>
              ...
              <button
                ...
                className="w-1/3 h-full text-center text-white rounded-r-md text-2xl flex justify-center items-center px-2"
              >
                +
              </button>
            </div>
